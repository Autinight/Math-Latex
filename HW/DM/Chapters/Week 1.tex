...
\begin{exercise}{通过粘接构造光滑流形}{}
    \begin{enumerate}
        ...
        \end{enumerate}
        \item 假设给定一族开集 \(  \left\{ V_{\alpha } \right\}  \). 对于每一对 $(\alpha, \beta)$, 给定 $V_\alpha$ 中的一个开集\(  V_{\alpha \beta }  \) , 给定一族微分同构$\varphi_{\alpha\beta}: V_{\alpha\beta} \to V_{\beta\alpha}$. 并且, 这一族映射 $\{\varphi_{\alpha\beta}\}$ 满足cocycle条件. 令 \(  \tilde{M}=  \sqcup V_{\alpha }  \). 定义 ``\(  \sim   \) '': \[
...
\begin{proof}
 \begin{enumerate}
    \item \begin{enumerate}
        \item 对于任意的 \(  x \in V_{\alpha }\cap U_{\beta }\cap U_{ \gamma }  \), 我们有 \[
        \begin{aligned}
        ...
        \end{aligned}
        \]因此在 \(  U_{\alpha }\cap U_{\beta }\cap U_{ \gamma }  \)上成立 \(   \varphi _{\beta  \gamma }\circ  \varphi _{\alpha \beta }=  \varphi _{\alpha  \gamma }  \).
        ...
        \item 对于任意的 \(  x \in U_{\alpha }\cap U_{\beta }  \) 
    \end{enumerate}
    \(  x \in V_{\alpha },  \varphi _{\alpha }^{-1} \left( x \right)\in U_{\beta }   \) 
 \end{enumerate}
