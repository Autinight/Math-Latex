...
\begin{proof}
    \(  X\vee X^{\prime} = \left( X \coprod  X^{\prime}  \right)/ \left\{ x\sim x^{\prime}  \right\}   \) . Considering map \(   \varphi : X\times X^{\prime}  \to X\vee  X^{\prime}   \) \[
     \varphi \left( x_1,x_2 \right)=\begin{cases} x_1,& x_2= x^{\prime} \\ 
      x_2,&x_1= x \end{cases} 
    \]  \[
    \varphi \left( x_1,x_2 \right)= \left( 1+ x_2-x^{\prime}  \right)\left(x_1\right) 
    \]
\end{proof}
...
\begin{problem}{}{}
    \begin{enumerate}
        \item Let \(  A  \) be a compact subspace of a Hausdorff space \(  X  \) . Prove that \(  X/A  \) is Hausdorff .   
    \end{enumerate}
    
\end{problem}
\begin{proof}
    \begin{lemma}{}{}
         \(  G  \)作用在 \(  X  \)上. 假设 \(  G  \)作用是proper的. \[
         \begin{aligned}
         G\times X&\to  X\times X\\ 
          \left( g,x \right)&\mapsto \left( g \cdot x, x \right)   
         \end{aligned}
         \]   
    \end{lemma}
    \(  \forall [x] , [y] \in  X  / A  \).  
    \begin{enumerate}
        \item  \(  x\not\in A , y\not\in A  \) . Let \(  p: X\to  X/ A  \) is the quotient map . Take a neiboughood of \(  x,y  \)  ,  \(  U_{x}, U_{y}  \), such that \(  U_{x}\cap U_{y}  = \varnothing\) , \(  U_{x}\cap A \neq \varnothing, U_{y}\cap A \neq \varnothing  \). 
        \begin{lemma}{}{}
