...
\begin{example}{}{}
  \begin{enumerate}
    ...
    \det : \mathrm{Mat}\left( n,\mathbb{R}  \right)&\to \mathbb{R} \\ 
     M&\mapsto \det M  
    \end{aligned}
    \]  \(  SL  \left( n,\mathbb{R}  \right)= \det ^{-1} \left( I \right)  \). 取一个 \(  M \in \mathrm{Mat}\left( n,\mathbb{R}  \right)   \), \(  \det M= 1  \). 要证明 \(  \left( \,\mathrm{d} \left( \det  \right)  \right)_{M}: \mathbb{R} ^{n^{2}}\to \mathbb{R}    \)   
  \end{enumerate}
